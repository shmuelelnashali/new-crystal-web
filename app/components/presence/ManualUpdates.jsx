      ...
      {updates.map((item, index) => (
        <div  key={index} className="dirRtl px-2 ">
          ...
          <div className="pt-0.5">
           <div
            className="bg-[#E4EBF8] font-semibold text-center py-1 grid grid-cols-3 rounded-full  items-center justify-around"
          >
          ...
          {item.changes.map((change, idx) => (
            <div key={idx} className="w-full">
              <div className="font-normal py-2  grid grid-cols-3  items-center justify-center">
                ...
                <div className="text-center font-medium">{change.value.slice(0, 5)}</div>
              </div>
