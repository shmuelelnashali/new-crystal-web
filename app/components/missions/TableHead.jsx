  ...
  return (
    <div className="flex w-full bg-[#EFF3FB] p-1 sticky top-0 z-10">
      <div className="flex w-full bg-blue_color rounded">
        ...
        <div
          className={`text-[20px] grid ${pathName.includes("employees") ?"grid-cols-11" : "grid-cols-10"} gap-3 w-full font-semibold leading-6 py-3 text-center items-center text-white`}
        >
