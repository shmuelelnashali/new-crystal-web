...
export default function AddEvent({ missionDay, setMissionDay,fromDate, setFromDate ,toDate, setToDate, eventDate, setEventDate }) {
    ...
    <div className="w-full px-2 font-normal text-lg ">
      <div className="w-full ">
        <div className="font-bold">סוג פעילות</div>
          <Option data={activity_type} handelDate={handelDate} activityDay={activityDay}/>
