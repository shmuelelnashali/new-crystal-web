...
export default function AddNewEmployee({ setAddNewEmployee, setEmployees }) {
...
//   // }, []);
  ...
  const cancelAdding = ()=> toast('בחרת לא להוסיף עובד',
    {
      icon: '👌',
      style: {
        borderRadius: '10px',
      ...
      <div className="bg-white rounded-lg p-5 w-3/4 ">
        <div className=" p-4 relative flex items-center justify-center">
          <div
            ...
            onClick={() => {setAddNewEmployee(false), cancelAdding()}}
          >
